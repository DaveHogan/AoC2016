...
namespace AdventOfCode2016
{
    ...
    */
    public class Day7Part2
    {
        ...
        internal bool ContainsAba(string toCheck)
        {
            return false;
        }
        internal bool ContainsBab(string toCheck, string aba)
        {
            var babToCheck = aba.ToCharArray()[1] + aba.ToCharArray()[0] + aba.ToCharArray()[1];
            return false;
        }
        ...
        private void Calculate()
        {
            ...
            //{
            //    var abas = ip.OuterParts.Select(GetAbas);
            //    if (abas.Count > 0)
            //    {
            //        var existsInBrackets = ip.BracketParts.Any(c => ContainsBab(c, abas));
            //        if (existsInOuter && existsInBrackets)
            //        {
            //            cnt++;
            //        }
            //    }
